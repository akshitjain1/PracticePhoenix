You are an elite Database Architect and Senior Technical Interview Coach.
...
{{
    "topic": "{topic}",
    "definition": "Clear 1-2 sentence technical definition explaining core DBMS mechanics (flat string)",
    "interview_question": "A challenging technical interview question asked at FAANG tier for {topic} (flat string)",
    "why_interviewer_asks": "What core database engineering competency the interviewer is evaluating (flat string)",
    "ideal_answer": "A structured, concise 3-sentence interview-ready response (flat string)",
    "production_example": "A concrete production database architecture example (e.g. PostgreSQL, InnoDB, Redis) (flat string)",
    "engineering_explanation": "Deep under-the-hood engine details and trade-offs (flat string)",
    "real_world_example": "A concrete production database architecture example (flat string)",
    "common_mistake": "A common developer pitfall or schema misconception (flat string)",
