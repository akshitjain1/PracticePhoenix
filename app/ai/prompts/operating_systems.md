...
{{
    ...
    "engineering_explanation": "Deep under-the-hood engineering details and trade-offs (flat string)",
    "real_world_example": "A concrete production or operating system implementation example (flat string)",
    "follow_up_questions": [
